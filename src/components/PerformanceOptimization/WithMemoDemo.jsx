...
const WithMemoDemo = () => {
  ...
  return (
    <div className="comparison-side with-optimization">
      <h3 className="comparison-title">✅ With useMemo</h3>
      <br/>
      <div className="parent-component">
        ...
        <div className="render-info">
          ...
          <p className="calculation-count">
            Expensive Calculation Runs: <strong className="calc-stable">{calculationCount.current}</strong>
        ...
        <div className="info-box small">
          ...
          <ul>
            ...
            <li>✅ Calculation Runs stays the same (using cached result)</li>
            <li>✅ Result is returned instantly from cache</li>
          </ul>
        </div>
      </div>
    </div>
